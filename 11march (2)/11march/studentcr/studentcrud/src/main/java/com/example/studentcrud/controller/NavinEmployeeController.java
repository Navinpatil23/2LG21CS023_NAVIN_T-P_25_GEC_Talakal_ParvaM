...
import com.example.studentcrud.service.NavinEmployeeService;

@Controller
@RequestMapping("/Navin")

public class NavinEmployeeController {

    @Autowired
    private NavinEmployeeService employeeService;
